...
grep -Fqx 'COPY --from=providers --chown=keycloak:keycloak --chmod=0644 /build/spi/target/e-skylab-spi-1.13.2.jar /opt/keycloak/providers/e-skylab-spi-1.13.2.jar' "$KEYCLOAK_DIR/Dockerfile" \
